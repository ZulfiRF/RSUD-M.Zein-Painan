...
using Core.Framework.Windows.Implementations.ButtonSpinner.Implementation;
using Core.Framework.Windows.Implementations.Common.Primitives;

namespace Core.Framework.Windows.Implementations.DateTimeUpDown.Implementation
{
  public class DateTimeUpDown : DateTimeUpDownBase<DateTime?>
  {
    ...
    {
        if ((this.TemplatedParent is Core.Framework.Windows.Implementations.TimePicker.Implementation.TimePicker)
        && ((Core.Framework.Windows.Implementations.TimePicker.Implementation.TimePicker)this.TemplatedParent).TemplatedParent is DateTimePicker.Implementation.DateTimePicker)
        return;

...
using Core.Framework.Windows.Implementations.Common.Utilities;

namespace Core.Framework.Windows.Implementations.Common.Primitives
{
    public class ValueRangeTextBox : Core.Framework.Windows.Implementations.AutoSelectTextBox.Implementation.AutoSelectTextBox
  {

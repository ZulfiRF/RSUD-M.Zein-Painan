...
using Core.Framework.Windows.Implementations.AutoSelectTextBox.Implementation;
using Core.Framework.Windows.Implementations.Common.Primitives;

namespace Core.Framework.Windows.Implementations.NumericUpDown.Implementation
{

...
namespace Core.Framework.Windows.Implementations.DateTimePicker.Implementation
{
  [TemplatePart( Name = PART_Calendar, Type = typeof( System.Windows.Controls.Calendar ) )]
  [TemplatePart( Name = PART_Popup, Type = typeof( Popup ) )]
  [TemplatePart(Name = PART_TimeUpDown, Type = typeof(Core.Framework.Windows.Implementations.TimePicker.Implementation.TimePicker))]
  public class DateTimePicker : DateTimeUpDown.Implementation.DateTimeUpDown
  {
    ...
    private Core.Framework.Windows.Implementations.TimePicker.Implementation.TimePicker _timePicker;
    ...
    {
      return DateTimeUpDown.Implementation.DateTimeUpDown.IsFormatStringValid( value );
    }
    ...
    public override void OnApplyTemplate()
    {
      ...
      _timePicker = GetTemplateChild(PART_TimeUpDown) as Core.Framework.Windows.Implementations.TimePicker.Implementation.TimePicker;
    }

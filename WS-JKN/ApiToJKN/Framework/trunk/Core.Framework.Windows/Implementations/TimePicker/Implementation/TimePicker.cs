...
namespace Core.Framework.Windows.Implementations.TimePicker.Implementation
{
  ...
  public class TimePicker : Control
  {
    ...
    {
        return Core.Framework.Windows.Implementations.DateTimeUpDown.Implementation.DateTimeUpDown.IsFormatStringValid(value);
    }

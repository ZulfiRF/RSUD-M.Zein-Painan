namespace Core.Framework.Windows.Models.Win32
{
    ...
    internal enum WS : uint
    {
        ...
        ///     defined after it, up to the next control with the WS_GROUP style.
        ///     The first control in each group usually has the WS_TABSTOP style so that the user can move from group to group. The
        ...
        /// <summary>
        ///     The window is a pop-up window. The WS_CAPTION and WS_POPUPWINDOW styles must be combined to make the window
        ///     menu visible.
        /// </summary>

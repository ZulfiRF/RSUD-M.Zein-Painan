...
using Core.Framework.Windows.Barcodes.Aztec.Internal;
using Core.Framework.Windows.Barcodes;

namespace Core.Framework.Windows.Barcodes.Aztec
{
   /// <summary>
   ...
   public class AztecReader : Reader
   {
      ...
      /// </summary>
      /// <param name="image">image of barcode to decode</param>
      /// <param name="hints">passed as a {@link java.util.Hashtable} from {@link Core.Framework.Windows.Barcodes.DecodeHintType}

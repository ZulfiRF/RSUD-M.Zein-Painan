...
using Core.Framework.Windows.Barcodes.QrCode.Internal;

namespace Core.Framework.Windows.Barcodes.QrCode
{
   /// <summary>
   ...
   public class QrCodeEncodingOptions : EncodingOptions
   {
      ...
      /// {@link Core.Framework.Windows.Barcodes.qrcode.decoder.ErrorCorrectionLevel ErrorCorrectionLevel}.
      /// </summary>

...
namespace Core.Framework.Windows.Barcodes.Common.Detector
{
   ...
   public sealed class MonochromeRectangleDetector
   {
      ...
      /// the barcode
      /// </param>
      /// <returns> a {@link Core.Framework.Windows.Barcodes.ResultPoint} encapsulating the corner that was found
      /// </returns>

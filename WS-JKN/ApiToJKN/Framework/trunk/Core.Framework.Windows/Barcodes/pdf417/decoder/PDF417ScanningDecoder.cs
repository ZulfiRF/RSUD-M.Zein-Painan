...
using Core.Framework.Windows.Barcodes.PDF417.Internal.EC;
using Core.Framework.Windows.Barcodes.pdf417.decoder;

namespace Core.Framework.Windows.Barcodes.PDF417.Internal
{
   /// <summary>
   /// 
   /// </summary>

namespace Core.Framework.Windows
{
    ...
    {
        internal static readonly ResourceDictionary LightResource = new ResourceDictionary { Source = new Uri("pack://application:,,,/Core.Framework.Windows;component/Styles/Accents/BaseLight.xaml") };
        internal static readonly ResourceDictionary DarkResource = new ResourceDictionary { Source = new Uri("pack://application:,,,/Core.Framework.Windows;component/Styles/Accents/BaseDark.xaml") };
        ...
        public static IList<Accent> DefaultAccents
        {
            get
            {
                ...
                var colors = new[] { "Dark", "Blue", "Purple", "Orange", "Green", "Gray", "Red", "Medifirst" };

                _accents = new List<Accent>(colors.Length);

                foreach (string color in colors)
                {
                    _accents.Add(new Accent(color, new Uri(string.Format("pack://application:,,,/Core.Framework.Windows;component/Styles/Accents/{0}.xaml", color))));
                }
        ...
        internal static bool GetThemeFromResources(Theme presetTheme, ResourceDictionary dict, ref Tuple<Theme, Accent> detectedAccentTheme)
        {
            ...
            Accent matched = null;
            if ((matched = ((List<Accent>)DefaultAccents).Find(x => x.Resources != null && x.Resources.Source == dict.Source)) != null)
            {

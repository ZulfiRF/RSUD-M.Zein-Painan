namespace Core.Framework.Windows.Helper.DragDropFramework
{
    ...
    public class Utility
    {
        ...
        public static T FindParentControlExcludingMe<T>(DependencyObject depObj) where T : DependencyObject
        {
            while (depObj != null)
            {
                if (depObj is Visual)
        ...
        /// <returns>Object of type <code>T</code> or null</returns>
        public static T FindParentControlIncludingMe<T>(DependencyObject depObj) where T : DependencyObject
        {
            while (depObj != null)
            {
                if (depObj is T)

...
namespace Core.Framework.Windows.Helper.DragDropFrameworkData
{
    ...
    ///     a StackPanel (of type TContainer) and
    ...
    public class StackPanelDataConsumer<TContainer, TObject> : DataConsumerBase, IDataConsumer
        where TContainer : StackPanel where TObject : UIElement
    {
        #region Constructors and Destructors

        public StackPanelDataConsumer(string[] dataFormats)
            : base(dataFormats)
        {
        }
        ...
        {
            var dataProvider = this.GetData(e) as StackPanelDataProvider<TContainer, TObject>;

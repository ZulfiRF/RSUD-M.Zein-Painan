...
namespace Core.Framework.Windows.Controls
{
    ...
    public static class TreeHelper
    {
        ...
        public static IEnumerable<DependencyObject> GetChildObjects(this DependencyObject parent)
        {
            ...
            if (parent is ContentElement || parent is FrameworkElement)
            {
                ...
                foreach (object obj in LogicalTreeHelper.GetChildren(parent))
                {
                    ...
                    if (depObj != null)
                    {
                        foreach (var child in depObj.GetChildObjects())
                        {
        ...
        /// </returns>
        public static T TryFindParent<T>(this DependencyObject child, Func<T, bool> invoke = null) where T : class //where T : DependencyObject
        {
            //get parent item
        ...
        ///     reference is being returned.
        /// </returns>
        public static T TryFindParent<T>(this DependencyObject child, string resourceName) where T : class //where T : DependencyObject
        {
            //get parent item
            DependencyObject parentObject = GetParentObject(child);
            ...
            if (parent != null)
            {
                ...
                if (frameworkElement != null && frameworkElement.Name.Equals(resourceName))
                    return parent;
            }
            //use recursion to proceed with next level
            return TryFindParent<T>(parentObject, resourceName);
        }

...
namespace Core.Framework.Barcodes.Client.Result
{
   ...
   /// a URL, or an e-mail address. {@link #parseResult(Core.Framework.Barcodes.Result)} will turn a raw
   ...
   public abstract class ResultParser
   {
      ...
      public abstract ParsedResult parse(Core.Framework.Barcodes.Result theResult);

      public static ParsedResult parseResult(Core.Framework.Barcodes.Result theResult)
      {

...
using Core.Framework.Barcodes.Common;
using Core.Framework.Barcodes.Aztec.Internal;

namespace Core.Framework.Barcodes.Aztec
{
   /// <summary>
   ...
   public class AztecReader : Reader
   {
      ...
      /// </summary>
      /// <param name="image">image of barcode to decode</param>
      /// <param name="hints">passed as a {@link java.util.Hashtable} from {@link Core.Framework.Barcodes.DecodeHintType}

...
using Core.Framework.Barcodes.Aztec;
using Core.Framework.Barcodes.Datamatrix;
using Core.Framework.Barcodes.Maxicode;
using Core.Framework.Barcodes.OneD;
using Core.Framework.Barcodes.PDF417;
using Core.Framework.Barcodes.QrCode;

...
namespace Core.Framework.Windows.Datagrid
{
  internal class ForeignKeyScrollTipContentControl : ForeignKeyContentControl
  {
    ...
    private void UpdateContentTemplate()
    {
      ...
      Core.Framework.Windows.Datagrid.Views.UIViewBase uiViewBase = null;
      ...
      if( dataGridContext != null )
      {
        ...
        {
          uiViewBase = dataGridControl.GetView() as Core.Framework.Windows.Datagrid.Views.UIViewBase;
        }
      }

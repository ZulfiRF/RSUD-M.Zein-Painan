...
namespace Core.Framework.Windows.Datagrid.Markup
{
  public class ThemeConverter : TypeConverter
  {
    ...
    public override object ConvertFrom( ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value )
    {
      ...
      if( stringValue != null )
      {
        ...
        Core.Framework.Windows.Datagrid.Views.Theme theme = null;
    ...
    private static readonly Core.Framework.Windows.Datagrid.Views.Theme s_classicSystemColorTheme = new ClassicSystemColorTheme();
    private static readonly Core.Framework.Windows.Datagrid.Views.Theme s_lunaNormalColorTheme = new LunaNormalColorTheme();
    private static readonly Core.Framework.Windows.Datagrid.Views.Theme s_lunaHomesteadTheme = new LunaHomesteadTheme();
    private static readonly Core.Framework.Windows.Datagrid.Views.Theme s_lunaMetallicTheme = new LunaMetallicTheme();
    private static readonly Core.Framework.Windows.Datagrid.Views.Theme s_aeroNormalColorTheme = new AeroNormalColorTheme();
    
    private static readonly Core.Framework.Windows.Datagrid.Views.Theme s_royaleNormalColorTheme = new RoyaleNormalColorTheme();
    private static readonly Core.Framework.Windows.Datagrid.Views.Theme s_zuneNormalColorTheme = new ZuneNormalColorTheme();
    private static readonly Core.Framework.Windows.Datagrid.Views.Theme s_windows7Theme = new Windows7Theme();
  }
}

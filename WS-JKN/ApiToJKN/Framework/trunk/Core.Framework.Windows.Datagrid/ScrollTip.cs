...
namespace Core.Framework.Windows.Datagrid
{
  public class ScrollTip : ContentControl, IWeakEventListener
  {
      ...
      try
      {
        if( oldParentGridControl != null )
        {
          if( scrollTip.UsingDefaultScrollTipContentTemplate )
          {
            ...
            Core.Framework.Windows.Datagrid.Views.UIViewBase uiViewBase = oldParentGridControl.GetView() as Core.Framework.Windows.Datagrid.Views.UIViewBase;
    ...
    private void RefreshDefaultScrollTipContentTemplate()
    {
      ...
      Core.Framework.Windows.Datagrid.Views.UIViewBase uiViewBase = parentGridControl.GetView() as Core.Framework.Windows.Datagrid.Views.UIViewBase;

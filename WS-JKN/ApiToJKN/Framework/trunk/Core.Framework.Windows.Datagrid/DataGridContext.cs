...
using Core.Framework.Windows.Datagrid.Utils.Collections;
  ...
  public sealed class DataGridContext : DependencyObject, INotifyPropertyChanged, IWeakEventListener, IDataGridContextVisitable, ICustomTypeDescriptor
  {
    ...
    public ObservableCollection<DataTemplate> Footers
    {
      get
      {
        ...
        Core.Framework.Windows.Datagrid.Views.ViewBase view = m_dataGridControl.GetView( false );
        if( view == null )
    ...
    internal CollectionViewGroup GetParentGroupFromItemCore( object item, bool recurseDetails )
    {
      ...
      {
        Core.Framework.Windows.Datagrid.Views.ViewBase view = m_dataGridControl.GetView();
...
#pragma warning restore 618
      ...
      IValueConverter converter = new Core.Framework.Windows.Datagrid.Converters.SourceDataConverter( ItemsSourceHelper.IsItemSupportingDBNull( dataItem ), CultureInfo.InvariantCulture );
        ...
        if( this.Items.Count > 0 )
        {
          ...
          foreach( ColumnBase visibleColumn in this.VisibleColumns )
          {
            if( this.ItemsSourceFieldDescriptors.TryGetValue( visibleColumn.FieldName, out fieldDescriptor ) )
            {
              ...
              {
                Core.Framework.Windows.Datagrid.Converters.ImageConverter converter = new Core.Framework.Windows.Datagrid.Converters.ImageConverter();
    ...
    PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties( Attribute[] attributes )
    {
      if( attributes == null )
      {
        ...
        if( m_viewPropertiesDescriptors == null )
        {
          Core.Framework.Windows.Datagrid.Views.ViewBase view = this.DataGridControl.GetView();
    ...
    internal void RaiseIsSelectedChangedAutomationEvent( DependencyObject container, bool isSelected )
    {
      ...
      if( ( peer != null ) && ( peer.ItemPeers != null ) )
      {
        ...
        if( item != null )
        {
          Core.Framework.Windows.Datagrid.Automation.DataGridItemAutomationPeer itemPeer = peer.ItemPeers[ item ] as Core.Framework.Windows.Datagrid.Automation.DataGridItemAutomationPeer;
    ...
    {
      public ViewBindingPropertyDescriptor( DetailConfiguration detailConfig, DefaultDetailConfiguration defaultDetailConfig, Core.Framework.Windows.Datagrid.Views.ViewBase view, DependencyProperty dp, ViewPropertyMode viewPropertyMode )
        : base( dp.Name, null )
      {
        if( dp == null )
      ...
      public Core.Framework.Windows.Datagrid.Views.ViewBase View
      {
        get
        {
          return m_view;
      ...
      private Core.Framework.Windows.Datagrid.Views.ViewBase m_view;

...
namespace Core.Framework.Windows.Datagrid.FilterCriteria
{
  ...
  [DebuggerDisplay( "GreaterThan( {Value} )" )]
  public class GreaterThanFilterCriterion : RelationalFilterCriterion
  {
    public GreaterThanFilterCriterion()
      : base()
    {
    }

    public GreaterThanFilterCriterion( object value )
      : base( value )
    {
    }
    ...
    public override System.Linq.Expressions.Expression ToLinqExpression( System.Linq.IQueryable queryable, ParameterExpression parameterExpression, string propertyName )
    {
      ...
      return queryable.CreateGreaterThanExpression( parameterExpression, propertyName, this.Value );
    }
    ...
    {
      StringBuilder stringBuilder = new StringBuilder( "GreaterThan( " );

...
using Core.Framework.Windows.Datagrid.ValidationRules;
...
namespace Core.Framework.Windows.Datagrid
{
  ...
  public abstract class Row : Control, IPrintInfo, IDataGridItemContainer
  {
    ...
    static Row()
    {
      ...
      Validation.ErrorTemplateProperty.OverrideMetadata( typeof( Core.Framework.Windows.Datagrid.Row ),
    ...
    protected internal virtual void PrepareDefaultStyleKey( Core.Framework.Windows.Datagrid.Views.ViewBase view )
    {
    ...
    internal Cell ProvideCell( ColumnBase column )
    {
      ...
      Core.Framework.Windows.Datagrid.Views.ViewBase view = dataGridContext.DataGridControl.GetView();

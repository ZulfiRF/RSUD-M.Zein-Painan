      ...
      if( Mouse.Captured != groupNavigationControl )
      {
        if( e.OriginalSource == groupNavigationControl )
        {
          if( ( Mouse.Captured == null )
            && ( TreeHelper.IsDescendantOf( originalSource, groupNavigationControl ) ) )
          {
            groupNavigationControl.Close();
          }
        }
        else if( ( originalSource != null ) && ( TreeHelper.IsDescendantOf( originalSource, groupNavigationControl ) ) )
        {

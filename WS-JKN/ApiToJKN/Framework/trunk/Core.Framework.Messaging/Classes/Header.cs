...
namespace Core.Framework.Messaging.Classes
{
    ...
    public class Header
    {
        ...
        /// </summary>
        private readonly NameValueCollection fields = new NameValueCollection();
        ...
        public Header(string data)
        {
            ...
            int version;
            Int32.TryParse(fields["sec-websocket-version"], out version);

            if (!String.IsNullOrEmpty(fields["sec-websocket-protocol"]))
            {
                SubProtocols = fields["sec-websocket-protocol"].Split(',');
            }

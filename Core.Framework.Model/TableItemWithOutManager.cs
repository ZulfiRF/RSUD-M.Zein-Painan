...
{
    [Serializable]
    public class TableItemWithOutManager :  INotifyPropertyChanged, ILoadModel

    {
        ...
        protected internal Dictionary<string, object> Dictionarys { get; set; }
        ...
        protected internal Dictionary<string, object> Previous { get; set; }
        ...
        public TableItemWithOutManager(Dictionary<string,object> data )
        {
            Dictionarys = data;
        }
        ...
        public void OnInit(IDataReader read, ContextManager contextManager)
        {
            IsNew = false;
            if (Dictionarys == null)
                Dictionarys = new Dictionary<string, object>();
            if (Previous == null)
        ...
        /// </summary>
        public TableItemWithOutManager()
        {
        ...
        {
            Dictionarys = new Dictionary<string, object>(cloneDictionary);
            return this;
        }
        ...
        {
            Previous = new Dictionary<string, object>(Dictionarys);
        }
        ...
        public virtual void OnInit(Dictionary<string, object> dictionaryData, bool isUpdate = false)
        {
                    ...
                    if (propertyInfo != null)
                        ...
                        if (Dictionarys.TryGetValue(dict.Key.ToLower(), out result))
                        {
                            ...
                            else if (propertyInfo.PropertyType.IsEnum)
                            {
                                ...
                                {
                                    if (valueObject != null && count == (Convert.ToInt16(valueObject.ToString().Trim())))
                                    {
        ...
        public Dictionary<string, object> GetDictionary()
        {
            ...
            return model;
            //new Dictionary<string, object>(Fields.ToDictionary(n => n.FieldName, n => this[n.FieldName]));
            //}
            //return Dictionarys;
        }
            ...
            if (item != null)
            {
                ...
                if (Type == RowType.CannotLoad)
                {
                    if (DictionaryReference == null)
                        DictionaryReference = new Dictionary<string, object>();
        ...
        protected CoreQueryable<T> GetReferences<T>(Type tableType, params string[] related) where T : TableItem
        {
            ...
            return new CoreQueryable<T>(new List<T>());
